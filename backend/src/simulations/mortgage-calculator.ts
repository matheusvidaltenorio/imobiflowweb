/**
 * Cálculos de financiamento (PRICE e SAC) para simulação.
 * Mantenha alinhado com frontend/src/lib/mortgage-calculator.ts
 */
...
/** Ajusta taxa mensal base (ex.: cadastrada no banco) conforme produto e indexador — modelo didático. */
...
/** SAC: amortização constante do saldo, juros sobre saldo devedor. */
