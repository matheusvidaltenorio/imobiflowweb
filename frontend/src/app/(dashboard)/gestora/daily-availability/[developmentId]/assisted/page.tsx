...
export default function GestoraAssistedDailyAvailabilityPage() {
  ...
  const { data: mapData, isLoading: mapLoading } = useQuery({
    queryKey: ['lot-map', developmentId, 'gestora-assisted'],
    queryFn: async () => {
        ...
        <Card className="space-y-4 p-6">
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            <div className="space-y-2 sm:col-span-2">
              ...
              <p className="flex h-10 items-center rounded-lg border border-surface-muted bg-surface/50 px-3 text-sm font-medium text-gray-800">
