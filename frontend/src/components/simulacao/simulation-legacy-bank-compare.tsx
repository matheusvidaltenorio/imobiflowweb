...
export function SimulationLegacyBankCompare() {
  ...
  return (
    <div className="legacy-bank-compare">
        <div className="mx-auto max-w-5xl">
          <p className="mb-6 text-sm text-gray-600">
            Compare bancos e prazos (PRICE). Limite de parcela: até 30% da renda (25% com 3+ dependentes). Idade máxima
            80 anos ao término do financiamento — prazos incluem até 420 meses quando permitido pela idade.
          </p>

          <Card className="border-primary-100/40 p-6 md:p-8">
